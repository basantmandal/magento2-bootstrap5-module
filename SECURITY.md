...
Only the latest release of HK2_AddBootstrap5 receives security patches. Older versions are not maintained.

| Version | Supported |
|---|---|
| 3.0.x (latest) | Supported |
| < 3.0 | Not supported |

## Reporting a Vulnerability

We take the security of our software seriously. If you discover a security vulnerability in HK2_AddBootstrap5, please report it privately before disclosing it publicly.
...
- Steps to reproduce the issue (including Magento version, PHP version, Bootstrap version selected, and any relevant configuration).
