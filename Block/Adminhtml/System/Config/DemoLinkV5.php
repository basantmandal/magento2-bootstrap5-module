...
class DemoLinkV5 extends Field
{
    /**
    ...
    /**
     * Return HTML representing the Bootstrap 5 Demo (Frontend).
     ...
     * The function then returns the HTML representing the Bootstrap 5 Demo (Frontend).
     *
    ...
    protected function _getElementHtml(AbstractElement $element): string
    {
        ...
        $demoUrl = $baseUrl . '/addbootstrap5/demo';

        return $this->renderUi($demoUrl);
    }

    /**
     * Returns HTML representing the Bootstrap 5 Demo (Frontend).
     * This function first calls the parent constructor with the provided context and data.
     * The function then assigns the provided StoreManagerInterface to the class's protected "storeManager" property.
     * The function then returns the HTML representing the Bootstrap 5 Demo (Frontend).
     *
    ...
    private function renderUi(string $demoUrl): string
    {
        ...
        ">
            ...
            <div style="margin-top:6px;font-size:12px;color:#64748b;">
                Bootstrap 5 Demo Url (admin-safe)
            </div>
        </div>';
    }
}
